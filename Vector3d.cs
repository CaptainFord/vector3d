...
//            return "(" + this.x + ", " + this.y + ", " + this.z + ")";
		...
		//	Non-static versions
		public Vector3d Min(Vector3d rhs) {
			return new Vector3d(Mathd.Min(this.x, rhs.x), Mathd.Min(this.y, rhs.y), Mathd.Min(this.z, rhs.z));
		}
		public Vector3d Max(Vector3d rhs) {
